  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Fikir Portalı</h1>
              ...
              <section className="grid gap-4">
                ...
                {shippedPosts.map((post) => (
                  <IdeaCard
                    ...
                    title={post.title}
                    href={`/portal/${post.id}`}
                    date={trDateFormatter.format(post.updatedAt)}
                    description={summarize(post.description)}
                    badges={
                      <>
              ...
              <section className="mt-4 grid gap-4">
                ...
                {activePosts.map((post) => (
                  <IdeaCard
                    ...
                    title={post.title}
                    href={`/portal/${post.id}`}
                    date={trDateFormatter.format(post.createdAt)}
                    description={summarize(post.description)}
                    badges={
                      <>
                        <StatusBadge status={post.status} />
