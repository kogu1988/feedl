...
- **Ürün revizyonu (bitti, 2026-09-12):** `docs/frontend_plan.md` P0 + P1'in seçili kısmı — iş etkisi katmanı (#22 sızıntı düzeltmesi, #23 görünürlük/açıklanabilirlik), roadmap bağlamı, gelir bazlı sıralama (#24). `docs/frontend_plan.md` P2 (CSV müşteri import, CRM/Salesforce/HubSpot/Stripe) ve "DO NOT BUILD" listesi bilinçli olarak yapılmadı.
- **Faz 2 — kalan:**
